...
function Cardsdvadva(props) {
    ...
    return (
        ...
        <section class="mx-auto max-w-5xl px-10 lg:5 py-5 lg:py-10">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-x-6 lg:gap-x-32 gap-y-12">
                <div>
                    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-1 gap-x-6   filter drop-shadow-lg  justify-center w-8 h-8 mb-4 text-red-600 bg-red-100 rounded-full">
                        <svg
